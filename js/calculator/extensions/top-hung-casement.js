/**
 * Extension for Top Hung Casement Window
...
if (typeof PriceCalculatorBase !== 'undefined') {
  // Create extended class for top-hung-casement window
  class PriceCalculatorTopHungCasement extends PriceCalculatorBase {
...
Generated from Live Price Calculator
    ...
    window.initCalculator = async function(productId, containerId = null) {
      if (TOP_HUNG_CASEMENT_PRODUCT_IDS.includes(productId)) {
        try {
          ...
          const calculator = new PriceCalculatorTopHungCasement(productId, productData, calcContainerId);
  ...
  // Export
  window.PriceCalculatorTopHungCasement = PriceCalculatorTopHungCasement;
}
