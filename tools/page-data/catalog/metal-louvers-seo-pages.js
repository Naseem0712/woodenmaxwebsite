    ...
    if (!cfg.skipSpecs) {
      ...
      out.bodySections.unshift({
        ...
        subsections: [
          ...
          { h3: 'Site measurement', body: '<p>Free measurement in <strong>Hyderabad, Delhi NCR & Jaipur</strong> for projects above minimum area. Other cities — video survey or architect drawing accepted.</p>' },
        ],
      });
    }
  }
...
const pages = [
  p({
    ...
    description: 'Aluminium louver ₹450–1,450/sqft installed. Facade, ventilation, wooden finish, motorized & perforated panels. WoodenMax fabricates in Hyderabad — free site visit Delhi, Jaipur, Hyderabad.',
  ...
  p({
    ...
    faqs: [
      { q: 'Is site visit free in Delhi NCR?', a: 'Yes — free visit for projects typically above <strong>120 sq.ft</strong> facade area in NCR.' },
    ],
  ...
  p({
    ...
    faqs: [
      { q: 'Do you offer site visits in Jaipur?', a: 'Free visit for qualifying facade area — confirm on WhatsApp with plot photos.' },
    ],
