  ...
  return {
    ...
    sections: [
      ...
      },
      {
        ...
        cards: [
          { icon: '1', title: 'Free site visit',  body: `${city.name} site engineer visits within <strong>48 hours</strong>. Measures every opening, photographs context, drafts shop drawing.` },
