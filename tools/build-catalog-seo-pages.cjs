...
' <div class="cluster-hero-cta">' + (cfg.isHub && cfg.silo === 'mirror-profiles'
 ...
 : (cfg.silo === 'mirror-profiles' ? '<a href="' + prefix + 'contact?intent=mirror-quote" class="cluster-cta-primary" data-ga-event="wm_cta_click">Get mirror quote &rarr;</a>' : '<a href="' + prefix + 'contact?intent=' + (cfg.silo === 'mirror-profiles' ? 'mirror' : 'louver') + '-quote" class="cluster-cta-primary" data-ga-event="wm_cta_click">Get Quote &rarr;</a>')) + '</div>\n' +
...
(cfg.silo === 'mirror-profiles' ? '<a href="' + prefix + 'contact?intent=mirror-quote&amp;source=' + esc(cfg.slug) + '" class="cluster-cta-primary" data-ga-event="wm_cta_click">Request formal quote &rarr;</a>' : '<a href="' + prefix + 'contact?intent=' + (cfg.silo === 'mirror-profiles' ? 'mirror' : 'louver') + '-quote&amp;source=' + esc(cfg.slug) + '" class="cluster-cta-primary" data-ga-event="wm_cta_click">Get Quote &rarr;</a>') + '</div></section>\n' +
