...
function fixFramelessPage() {
 ...
 const desc =
 'Frameless shower price India — walk-in glass enclosure from ₹440/sqft. 10mm toughened, hinged or sliding, L-corner & straight. Live calculator. Site measurement.';
 html = setMeta(html, { title, description: desc });
 html = html.replace(
 /<title>[^<]*<\/title>/,
 `<title>${title}</title>`
...
<header class="cluster-hero">
 ...
 <a href="././contact?intent=shower-quote&amp;city=${cfg.cityKey}" class="cluster-cta-secondary">Get Quote</a>
 </div>
 </div>
...
<section class="cluster-section">
 ...
 <ul>
 <li><strong>Site measurement</strong> — we visit your bathroom, confirm drain slope &amp; wall fixing points</li>
...
<section class="cluster-final-cta">
 ...
 <p>WhatsApp your bathroom size &amp; locality — we confirm exact ₹/sqft after site measurement.</p>
...
const CITY_PAGES = [
 ...
 cityName: 'Hyderabad',
 title:
 'Shower Glass Partition Hyderabad ₹440–1,320/sqft (2026) — Site Measurement | WoodenMax',
 h1: 'Shower Glass Partition Hyderabad — Price &amp; Installation (2026)',
 description:
 'Shower glass partition Hyderabad ₹440–1,320/sqft. Gachibowli, Banjara Hills, Jubilee Hills, Kukatpally. 3×5 ft ≈ ₹11,000–18,000. 1-day install.',
 areas: 'Gachibowli, Banjara Hills, Jubilee Hills, Kukatpally, Madhapur, Financial District &amp; surrounding GHMC',
 heroSub:
 'Shower glass partition supply &amp; install in Hyderabad — frameless walk-in, black profile sliding &amp; frosted options. Standard 3×5 ft shower ≈ ₹11,000–18,000. Site measurement, typical 1-day installation.',
 },
 {
 ...
 cityName: 'Delhi NCR',
 title:
 'Shower Glass Partition Delhi ₹440–1,320/sqft (2026) — Site Measurement | WoodenMax',
 h1: 'Shower Glass Partition Delhi NCR — Price &amp; Installation (2026)',
 description:
 'Shower glass partition Delhi NCR ₹440–1,320/sqft. Gurgaon, Noida, Dwarka, South Delhi. 3×5 ft ≈ ₹11,000–18,000. 1-day install.',
 areas: 'Gurgaon, Noida, Dwarka, Vasant Kunj, Greater Kailash, Saket &amp; wider NCR',
 heroSub:
 'Shower glass partition supply &amp; install across Delhi NCR — frameless walk-in, black profile sliding &amp; frosted options. Standard 3×5 ft shower ≈ ₹11,000–18,000. Site measurement, typical 1-day installation.',
 },
 {
 ...
 cityName: 'Bangalore',
 title:
 'Shower Glass Partition Bangalore ₹440–1,320/sqft (2026) — Site Measurement | WoodenMax',
 h1: 'Shower Glass Partition Bangalore — Price &amp; Installation (2026)',
 description:
 'Shower glass partition Bangalore ₹440–1,320/sqft. Whitefield, Koramangala, Indiranagar, HSR. 3×5 ft ≈ ₹11,000–18,000. 1-day install.',
 areas: 'Whitefield, Koramangala, Indiranagar, HSR Layout, Electronic City, Sarjapur &amp; BBMP zones',
 heroSub:
 'Shower glass partition supply &amp; install in Bangalore — frameless walk-in, black profile sliding &amp; frosted options. Standard 3×5 ft shower ≈ ₹11,000–18,000. Site measurement, typical 1-day installation.',
 },
];
...
function linkCitiesFromHub() {
 ...
 <p class="cluster-prose">Local ₹/sqft bands, site measurement &amp; 1-day installation — tap your city:</p>
 <div class="catalog-hub-grid catalog-hub-grid--compact">
 <a href="./shower-partitions/shower-partition-hyderabad" class="catalog-hub-card"><div class="catalog-hub-card-body" style="padding:1rem;"><strong>Hyderabad</strong><span>₹440–1,320/sqft · Get Quote</span></div></a>
 <a href="./shower-partitions/shower-partition-delhi" class="catalog-hub-card"><div class="catalog-hub-card-body" style="padding:1rem;"><strong>Delhi NCR</strong><span>₹440–1,320/sqft · Get Quote</span></div></a>
 <a href="./shower-partitions/shower-partition-bangalore" class="catalog-hub-card"><div class="catalog-hub-card-body" style="padding:1rem;"><strong>Bangalore</strong><span>₹440–1,320/sqft · Get Quote</span></div></a>
 </div>
 </div>
</section>
`;
